...
namespace MantosExtract.Core.I18n
{
    internal static partial class Strings
    {
        public static Dictionary<string, string> En() => new Dictionary<string, string>
        {
            ...
            ["me.extract.result.newImage"] = "Back to start",
            ...
            ["me.recraft.error.noKey"] = "Background removal and vectorizing are not configured on the server. Contact support.",
            ["me.recraft.error.invalidKey"] = "Background removal and vectorizing have a configuration problem. Contact support.",
            ["me.recraft.error.noCredit"] = "Background removal and vectorizing are temporarily unavailable. Contact support.",
            ["me.recraft.error.notInPlan"] = "Your plan does not include background removal and vectorizing. Talk to whoever manages your account.",
            ["me.recraft.error.quotaExceeded"] = "Your company has used up its background removal and vectorizing quota for this period. Talk to whoever manages your account.",
