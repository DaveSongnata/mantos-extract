...
namespace MantosExtract.AddIn.Ui
{
    ...
    /// Writes to %TEMP%\MantosExtract\docker.log. Best-effort: never throws.
    /// </summary>
    internal static class MantosExtractLog
    {
        ...
        private static string BuildPath()
        {
            try
            {
                string dir = System.IO.Path.Combine(System.IO.Path.GetTempPath(), "MantosExtract");
                Directory.CreateDirectory(dir);
                return System.IO.Path.Combine(dir, "docker.log");
            }
            catch { return System.IO.Path.Combine(System.IO.Path.GetTempPath(), "mantosextract_docker.log"); }
        }
